function [res_admm, out] = admmRedNlm(A,y,lambda,tol,N,max_iter,m,ni,rho)
...
for k = 1:1:max_iter
    ...
    for j = 1:1
        ...
        % PArameters: 0.012,17,7
        f_v_est1 = imnlmfilt(v_est1,'DegreeOfSmoothing',1, ...
            'SearchWindowSize',5, 'ComparisonWindowSize', 3);
        f_v_est2 = imnlmfilt(v_est2,'DegreeOfSmoothing',1, ...
            'SearchWindowSize',5, 'ComparisonWindowSize', 3);
