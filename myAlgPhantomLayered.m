...
dataDir = ['Q:\NonClinicalAvendanoData\May24_Focused_Phantoms_ComposedPhantoms' ...
    '\SavedData2405-SMA\bf'];
refDir = ['Q:\NonClinicalAvendanoData\May24_Focused_Phantoms_ComposedPhantoms' ...
    '\SavedData2405-SMA\ref'];
sampleFiles = dir(fullfile(dataDir,'*.mat'));
refFiles = dir(fullfile(refDir,'*Ref*.mat'));

resultsDir = 'Q:\smerino\REDjournalResults\layeredPhantom\mixed';
